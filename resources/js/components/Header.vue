<template>
    <div class="border-black border-t-2 flex items-center">
        <div
            ...
            class="cursor-pointer p-2.5 border-r-2"
            :class="[back.name === 'home' ? 'bg-green border-r-black' : 'border-r-transparent']"
        >
            <svg v-if="back.name === 'home'" class="h-[26px] w-[26px] fill-black" viewBox="0 0 32 32">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
